 ...
 */
	public function add($operationId) {
		$this->Path->Operation->id = $operationId;
		...
		if ($this->request->is('post')) {
			$this->Path->create();
			$this->request->data['Path']['operation_id'] = $operationId;

			if ($this->Path->save($this->request->data)) {

				$this->Path->Operation->updateOverview($operationId);
 ...
 */
	public function delete($id = null) {
		...
		$operationId = $this->Path->field('operation_id');
		if ($this->Path->delete()) {
			$this->Path->Operation->updateOverview($operationId);
